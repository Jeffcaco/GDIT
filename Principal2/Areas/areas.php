...
$query_areas = "select c.nombre as Gerencia, a.nombre as Area, a.idsubarea as id from subarea as a 
                            inner join area as c on a.idarea=c.idarea
                            order by a.idsubarea asc";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <br>
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Data Áreas</div>
                    <br>
                    <!--tabla-->
                                        ...
                                        <tbody>
                                            ...
                                            while ($area = mysqli_fetch_array($result2)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editArea<?php echo $area['id']; ?>">
                                                            Modificar <i class="fa-solid fa-pen-to-square" style="padding-left: 10px;"></i>
                                                        </button>

                                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteArea<?php echo $area['id']; ?>" style="margin-left: 15px;">
