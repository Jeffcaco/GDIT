...
$query_reportes = "select * from Dashboard";
                        ...
                        <div class="row">
                            <div class="col-md-12 p-2">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover" style="text-align: left !important;">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($reporte = mysqli_fetch_array($result2)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editReporte<?php echo $reporte['id_dashboard']; ?>">
                                                            Modificar <i class="fa-solid fa-pen-to-square" style="padding-left: 10px;"></i>
                                                        </button>

                                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteReporte<?php echo $reporte['id_dashboard']; ?>" style="margin-left: 15px;">
