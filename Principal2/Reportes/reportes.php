...
$query_reportes = "select * from Dashboard as a inner join Area as b on a.id_area_dashboard=b.id_area;";
$result2 = mysqli_query($conexion, $query_reportes);
$num_reportes = mysqli_num_rows($result2);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <br>
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Data Dashboard</div>
                    <br>
                    <!--tabla-->
                    ...
                    <br><i>Pdt: Las contraseñas tienen un máximo de 8 caracteres.</i>
                            ...
                            <div class="col-md-12 p-2">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            <?php
                                            while ($reporte = mysqli_fetch_array($result2)) { ?>
                                                <tr>
                                                    <td><?php echo $reporte['id_dashboard']; ?></td>
                                                    <td><?php echo $reporte['nombre_dashboard']; ?></td>
                                                    <td><?php echo $reporte['nombre_area']; ?></td>
                                                    <td> ******** </td>
                                                    <td>
                                                        <a href=<?php echo $reporte['link_dashboard']; ?> class="buttton text-dark fa-2x" target="_blank"><i class="fa-solid fa-square-poll-vertical text-warning"></i></a>
                                                    </td>

                                                    <td>
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editChildresn<?php echo $reporte['id_dashboard']; ?>">
                                                            Modificar <i class="fa-solid fa-pen-to-square" style="padding-left: 10px;"></i>
                                                        </button>

                                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteChildresn<?php echo $reporte['id_dashboard']; ?>" style="margin-left: 15px;">
